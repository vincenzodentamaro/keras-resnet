...
def basic_2d(
    ...
    def f(x):
        ...
        y = tensorflow.keras.layers.SeparableConv2D(filters, kernel_size, strides=stride, use_bias=False, name="res{}{}_branch2a".format(stage_char, block_char), **parameters)(y)
        ...
        y = tensorflow.keras.layers.SeparableConv2D(filters, kernel_size, use_bias=False, name="res{}{}_branch2b".format(stage_char, block_char), **parameters)(y)
        ...
        if block == 0:
            shortcut = tensorflow.keras.layers.SeparableConv2D(filters, (1, 1), strides=stride, use_bias=False, name="res{}{}_branch1".format(stage_char, block_char), **parameters)(x)
...
def bottleneck_2d(
    ...
    def f(x):
        y = tensorflow.keras.layers.SeparableConv2D(filters, (1, 1), strides=stride, use_bias=False, name="res{}{}_branch2a".format(stage_char, block_char), **parameters)(x)
        ...
        if block == 0:
            shortcut = tensorflow.keras.layers.SeparableConv2D(filters * 4, (1, 1), strides=stride, use_bias=False, name="res{}{}_branch1".format(stage_char, block_char), **parameters)(x)
