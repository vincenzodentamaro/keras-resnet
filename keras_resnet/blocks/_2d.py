...
def basic_2d(
    ...
    def f(x):
        ...
        y = keras.layers.SeparableConv2D(filters, kernel_size, strides=stride, use_bias=False, name="res{}{}_branch2a".format(stage_char, block_char), **parameters)(y)
        ...
        y = keras.layers.SeparableConv2D(filters, kernel_size, use_bias=False, name="res{}{}_branch2b".format(stage_char, block_char), **parameters)(y)
        ...
        if block == 0:
            shortcut = keras.layers.SeparableConv2D(filters, (1, 1), strides=stride, use_bias=False, name="res{}{}_branch1".format(stage_char, block_char), **parameters)(x)
...
def bottleneck_2d(
    ...
    def f(x):
        y = keras.layers.SeparableConv2D(filters, (1, 1), strides=stride, use_bias=False, name="res{}{}_branch2a".format(stage_char, block_char), **parameters)(x)
        ...
        y = keras.layers.SeparableConv2D(filters * 4, (1, 1), use_bias=False, name="res{}{}_branch2c".format(stage_char, block_char), **parameters)(y)
        ...
        if block == 0:
            shortcut = keras.layers.SeparableConv2D(filters * 4, (1, 1), strides=stride, use_bias=False, name="res{}{}_branch1".format(stage_char, block_char), **parameters)(x)
